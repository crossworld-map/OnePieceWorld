...
export default function Home() {
  return (
    <Layout>
      <Head>
        <title>Crossworld – Mapa de One Piece</title>
        <meta name="description" content="Explora el mundo de One Piece con este mapa interactivo fan-made." />
      </Head>
      <section style={{ textAlign: 'center', padding: '2rem 0' }}>
        <h2 style={{ fontSize: '2rem', marginBottom: '1rem' }}>Bienvenido a Crossworld</h2>
      ...
      <section style={{ padding: '2rem 0', textAlign: 'center' }}>
        ...
        {/* Una vez creado el perfil de Ko-fi, reemplaza href con tu enlace */}
        <a
